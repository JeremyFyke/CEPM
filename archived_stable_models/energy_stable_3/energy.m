...
global  run_type...
    ...
    cum_emissions = cumsum ( yearly_emissions ) + 5.e17 ; %add on 0.5 Tt emissions-to-date.
    cum_emissions = cum_emissions ./ 1.e18 ; %convert to Tt C
    ...
    if run_type == 1
        ...
        plot( yr , g_warm )
        xlabel('year')
        ylabel('Global mean equilibrium temperature anomaly (^oC)')
        axis tight
        subplot(2,4,7)
...
dVdt = ff_discovery_rate(V,t) -  population(t) .* per_cap_demand(t) ;
